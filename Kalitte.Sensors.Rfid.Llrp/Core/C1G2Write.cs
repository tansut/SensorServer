namespace Kalitte.Sensors.Rfid.Llrp.Core
{
    ...
    [Serializable]
    public sealed class C1G2Write : C1G2OPSpec
    {
        ...
        internal C1G2Write(BitArray bitArray, ref int index) : base(LlrpParameterType.C1G2Write, bitArray, index)
        {
        ...
        public C1G2Write(uint password, C1G2MemoryBank bank, ushort pointer, short[] data) : base(LlrpParameterType.C1G2Write)
        {
