namespace Kalitte.Sensors.Rfid.Llrp.Core
{
    ...
    [Serializable]
    public sealed class UtcTimestamp : LlrpTlvParameterBase
    {
        private ulong m_timeElapsed;

        public UtcTimestamp(ulong timeElapsed) : base(LlrpParameterType.UtcTimestamp)
        {
            this.Init(timeElapsed);
        }

        internal UtcTimestamp(BitArray bitArray, ref int index) : base(LlrpParameterType.UtcTimestamp, bitArray, index)
        {
