namespace Kalitte.Sensors.Rfid.Llrp.Core
{
    ...
    public sealed class C1G2WriteOPSpecResult : C1G2OPSpecResult
    {
        private ushort m_numberOfWordsWritten;
        private ushort m_opSpecId;
        private C1G2WriteOPSpecResultType m_resultType;

        internal C1G2WriteOPSpecResult(BitArray bitArray, ref int index) : base(LlrpParameterType.C1G2WriteOPSpecResult, bitArray, index)
        {
            uint parameterEndLimit = BitHelper.GetParameterEndLimit(bitArray, ref index);
            C1G2WriteOPSpecResultType enumInstance = BitHelper.GetEnumInstance<C1G2WriteOPSpecResultType>(BitHelper.ConvertBitArrayToNumber(bitArray, ref index, 8));
            ...
            this.Init(opSpecId, enumInstance, numberOfWordsWritten);
        }
        ...
        private void Init(ushort opSpecId, C1G2WriteOPSpecResultType resultType, ushort numberOfWordsWritten)
        {
        ...
        public override string ToString()
        {
            ...
            builder.Append("<C1G2 Write OP Spec Result>");
        ...
        public C1G2WriteOPSpecResultType ResultType
        {
            get
            {
