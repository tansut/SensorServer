    ...
    public class WindowsServiceHelper
    {
        ...
        public static void Uninstall(string ServiceName)
        {
            ...
            try
            {
                ...
                {
                    throw new UserException("Service not installed.");
                }
                try
                {
                    StopService(service);
                    ...
                    if (ret == 0)
                    {
                        ...
                        throw new UserException("Could not delete service " + error);
                    }
                }
                finally
                {
        ...
        string FileName)
        {
            ...
            try
            {
                ...
                if (service == IntPtr.Zero)
                {
                    throw new UserException("Failed to install service.");
                }
                try
                {
        ...
        public static void StartService(string Name)
        {
            ...
            try
            {
                ...
                {
                    throw new UserException("Could not open service.");
                }
                try
                {
        ...
        private static ServiceState GetServiceStatus(IntPtr hService)
        {
            ...
            {
                throw new UserException("Failed to query service status.");
            }
        ...
        private static IntPtr OpenSCManager(ServiceManagerRights Rights)
        {
            ...
            {
                throw new UserException("Could not connect to service control manager.");
            }
            return scman;
        }
    }
