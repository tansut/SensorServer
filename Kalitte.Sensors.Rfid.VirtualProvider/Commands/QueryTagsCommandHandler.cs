...
{
    internal class QueryTagsCommandHandler : CommandHandler
    {
        ...
        public QueryTagsCommandHandler(string source, SensorCommand command, VirtualDevice device, VirtualDeviceState state, ILogger logger) :
