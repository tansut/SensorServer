...
{
    internal class ApplyPropertyListCommandHandler : CommandHandler
    {
        ...
        public ApplyPropertyListCommandHandler(string source, SensorCommand command, VirtualDevice device, VirtualDeviceState state, ILogger logger) :
