<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LockTagCommandEditor.ascx.cs"
    Inherits="Kalitte.Sensors.Rfid.Client.CommandEditors.LockTagCommandEditor" %>
