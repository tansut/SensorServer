...
{
    public partial class LockTagCommandEditor : System.Web.UI.UserControl, ISensorCommandEditor
    {
        ...
        {            
            return new LockTagCommand(RfidHelper.GetBytes(ctlPasscode.Text),
