...
{
    public partial class UpgradeFirmwareCommandEditor : System.Web.UI.UserControl, ISensorCommandEditor
    {
        ...
        {
            return new UpgradeFirmwareCommand(ctlLocation.Text.Trim());
        }
