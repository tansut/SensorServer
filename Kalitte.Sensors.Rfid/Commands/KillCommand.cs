namespace Kalitte.Sensors.Rfid.Commands
{
    ...
    [Serializable]
    [SensorCommandEditor("Rfid/KillCommandEditor.ascx")]    
    public sealed class KillCommand : TagCommand
    {
        private readonly byte[] m_tagId;
        private KillResponse response;

        public KillCommand(byte[] passCode, byte[] tagId) : base(passCode)
        {
            this.m_tagId = tagId;
