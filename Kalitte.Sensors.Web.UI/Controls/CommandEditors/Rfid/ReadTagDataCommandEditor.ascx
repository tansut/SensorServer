<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReadTagDataCommandEditor.ascx.cs"
    Inherits="Kalitte.Sensors.Rfid.Client.CommandEditors.ReadTagDataCommandEditor" %>
...
<table class="formTable" cellspacing="0" cellpadding="0" id="ctlResult" runat="server" visible="false">
    <tr>
        <td class="labelCol">
