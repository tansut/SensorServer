...
Inherits="Kalitte.Dashboard.Management.WidgetEditor"
    Theme="" %>
                    ...
                    <tr>
                        ...
                        <td class="propTd">
                            <asp:UpdatePanel runat="server" ID="ctlup2" UpdateMode="Conditional" ChildrenAsTriggers="false">
                                <ContentTemplate>
                                    <asp:LinkButton ID="ctnEditWidget" runat="server" OnClick="ctnEditWidget_Click">Edit Widget Settings</asp:LinkButton>
