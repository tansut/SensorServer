<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="List.ascx.cs" Inherits="Kalitte.Sensors.Web.UI.Pages.Processors.List" %>
                ...
                <ext:Toolbar ID="Toolbar1" runat="server">
                    <Items>
                        <tt:TTButtonGroup ID="ButtonGroup1" runat="server" Title="Edit">
                            <Items>
                                <tt:TTCmdButon ID="ctlAddBtn" runat="server" KnownCommand="CreateInEditor" Text="Create New Processor" />
                                <tt:TTCmdButon ID="ctlEditBtn" runat="server" KnownCommand="EditInEditor" ShowMask="true" />
                                <tt:TTCmdButon ID="ctlCreateBtn" runat="server" KnownCommand="DeleteEntity" />
                                <tt:TTCmdButon ID="TTCmdButon1" runat="server" KnownCommand="EditInEditor" Icon="Package"
                                    CommandArgument="2" Text="View Modules" ShowMask="true" />
                            </Items>
                        </tt:TTButtonGroup>
                        <tt:TTButtonGroup ID="TTButtonGroup1" runat="server" Title="Management">
                            <Items>
                                <tt:TTCmdButon ID="TTCmdButon3" runat="server" KnownCommand="EditInEditor" CommandArgument="6"
                                    Icon="ChartBar" Text="Analyse Performance" ShowMask="true" />
                                <tt:TTCmdButon ID="TTCmdButon2" runat="server" KnownCommand="EditInEditor" CommandArgument="7"
                                    Icon="DatabaseRefresh" Text="View Log" ShowMask="true" />
                                <tt:TTCmdButon ID="TTCmdButon4" runat="server" KnownCommand="EditInEditor" CommandArgument="8"
                                    Icon="Cog" Text="View Last Events" ShowMask="true" />
                            </Items>
                        </tt:TTButtonGroup>
                        <%--                        <tt:TTButtonGroup ID="TTButtonGroup1" runat="server" Title="View States">
                            <Items>
                                <tt:TTCmdButon ID="TTCmdButon1" runat="server" CommandName="ViewModuleStates" Text="Modules" />
                                <tt:TTCmdButon ID="TTCmdButon2" runat="server" CommandName="ViewLogicalSensorStates"
                                    Text="Logical Sensors" />
                            </Items>
                        </tt:TTButtonGroup>--%>
                    </Items>
                </ext:Toolbar>
