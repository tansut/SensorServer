<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProcessorEditor.ascx.cs"
    Inherits="Kalitte.Sensors.Web.UI.Pages.Dispatchers.ProcessorEditor" %>
                ...
                <tt:TTPanel runat="server" Title="General" Layout="FitLayout" Padding="5">
                    <Items>
                        <tt:TTFormPanel runat="server" ID="ctlGenForm">
                            <Items>
                                <ext:Label runat="server" ID="ctlDispatcherName" FieldLabel="Dispatcher">
                                </ext:Label>
