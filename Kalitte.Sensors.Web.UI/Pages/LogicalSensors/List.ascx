<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="List.ascx.cs" Inherits="Kalitte.Sensors.Web.UI.Pages.LogicalSensors.List" %>
                ...
                <ext:Toolbar ID="Toolbar1" runat="server">
                    <Items>
                        <tt:TTButtonGroup ID="ButtonGroup1" runat="server" Title="Edit">
                            <Items>
                                <tt:TTCmdButon ID="ctlAddBtn" runat="server" KnownCommand="CreateInEditor" Text="Create New Logical Sensor" />
                                ...
                                <tt:TTCmdButon ID="TTCmdButon1" runat="server" KnownCommand="EditInEditor" Icon="DeviceStylus"
                                    CommandArgument="1" Text="View Sensors" ShowMask="true" />
                            </Items>
                        </tt:TTButtonGroup>
